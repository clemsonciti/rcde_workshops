...
* Script-based development workflows
...
This copies a script `download.sh` that, when run, will copy the full workshop files to your drivespace. Now that you have that script, run the command: `bash download.sh`. You should now have a folder, `pytorch_advanced`, which contains the workshop files.
