...
shared_folder = '/project/rcde/cehrett/pytorch_advanced/'

def create_answer_box(question, question_id, shared_folder=shared_folder):
...
def show_responses(question_id, shared_folder=shared_folder):
    """
