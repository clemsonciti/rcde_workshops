...
A more robust strategy is to acknowledge that 100% accuracy on the training set is impossible, and attempt to create a decision boundary which is a straight line or a low-degree polynomial.
