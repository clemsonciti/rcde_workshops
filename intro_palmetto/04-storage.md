...
| ---------------- | --------------------- | -------------- | ----------- | ------------------ | ---------------------- |
| `/home/{username}`          | 100 GB per user        | HDD            | `zfs`       | Ethernet           | yes |
| `/scratch1/{username}`      | 1933 TB                | HDD            | `beegfs`    | IB, Ethernet       | no                 |
| `/fastscratch/{username}`   | 168 TB                 | NVMe           | `beegfs`    | IB, Ethernet       | no                 |
| `/local_scratch` | 99 GB - 2.7 TB per node | HDD, SSD, NVMe | `ext4`      | internal           | no                 |
...
Since most of you are new users of Palmetto 2, you should be using very little storage at the moment.

When you log into Palmetto 2, you end up in your home directory. To see which directory you are in, type
