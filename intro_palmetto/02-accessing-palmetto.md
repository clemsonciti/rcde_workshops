...
Palmetto 2 is accessed using the SSH (["Secure shell"](https://en.wikipedia.org/wiki/Ssh_(Secure_Shell))) protocol. Palmetto 2 runs the *SSH server*; on your local machine, you will need to run *SSH client* which connects to a server using a command line *terminal*. The commands that are entered in the terminal are processed by the server on Palmetto 2.
...
and password, then authorize 2FA with Duo. Use your usual Clemson username (without the @clemson.edu part) and Clemson
password.
...
- Palmetto 2 can be accessed by an SSH (secure shell) client
