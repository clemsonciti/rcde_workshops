...
You can also use the web interface to run a terminal on Palmetto 2. This way, OpenOD becomes an alternative to MobaXTerm or to the Mac Terminal application. To start the terminal, click on `Clusters`, then `Palmetto Shell Access`:
...
- Open OnDemand can be used to launch interactive applications with a GUI that runs on Palmetto 2
