...
Need a quick refresher on the commands to use Git? Check out this [Git cheat sheet](https://education.github.com/.git-cheat-sheet-education.pdf)

## RCD GitLab

If you want to collaborate on **research** or **educational** projects with
other Clemson users, you can take advantage of the RCD GitLab service.

To get started, see the [RCD GitLab Documentation](https://docs.rcd.clemson.edu/gitlab).
...
- [The Pro Git book](https://git-scm.com/book/en/v2) available for free online!
